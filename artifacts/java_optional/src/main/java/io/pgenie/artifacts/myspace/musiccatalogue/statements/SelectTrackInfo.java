...
public record SelectTrackInfo(
    ...
    public Result decodeResultSet(ResultSet rs) throws SQLException {
        ...
        Optional<TrackInfo> trackInfoCol = TrackInfo.CODEC.decodeOptional(rs, 0, 1);
        Optional<Integer> idCol = Codec.INT4.decodeOptional(rs, 0, 2);
